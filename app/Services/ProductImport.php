    ...
    public function import($rows)
    {
        ...
        try {
            ...
            foreach ($this->rows as $row) {
                list($productId, $imagePath, $name, $categoryName, $tagName, $productInformation, $originName, $ingredients, $nutritionalContent, $storage, $otherInformation, $buyTwoGet, $price, $pricePerItem, $comparePrice, $pant, $status, $weight, $discountPrice, $subcategoryName, $subsubcategoryName, $veckansExtrapriser, $veckansQty, $tax, $popularity ) = $row;
                ...
                try {
                    $productData = [
                        ...
                        'sub_cat_id' => $subcategory->id??NULL,
                        // 'subsub_cat_id' => optional($subsubcategory)->id,
                        'subsub_cat_id' => $subsubcategory->id??NULL,
                        ...
                        'veckans_extrapriser' => ($veckansExtrapriser),
                        'veckans_qty' => ($veckansQty),
                        'tax' => ($tax),
