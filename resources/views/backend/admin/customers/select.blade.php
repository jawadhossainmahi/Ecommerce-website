                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        <div class="controls">
                                            ...
                                            <input type="date" class="form-control  @error('discount_price') is-invalid @enderror"  placeholder="Födelsedatum"  name="data_of_birth" value="{{$customers->date_of_birth}}">
                                        </div>
                                    </div>
                                </div>
