            ...
            <section class="users-edit">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form-validate" action="{{ route('admin.order.store') }}" method="POST" id="product_form">
                            @csrf
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        <div class="controls">
                                            ...
                                            <select id="user_id"  class="form-control @error('user_id') is-invalid @enderror" name="user_id">
                                                ...
                                                <option value="{{$item->id}}" @if ($item->id ==   old('user_id')) selected @endif> {{$item->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <option value="{{$productid->id}}" @if (in_array($productid->id, old('product_id') ?? [])) selected  @endif>{{$productid->name}}</option>
                                    @endforeach
                                        </select>
                                    </fieldset>
                                </div>
