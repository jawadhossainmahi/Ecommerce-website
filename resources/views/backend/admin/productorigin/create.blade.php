                ...
                <div class="breadcrumbs-top">
                    ...
                    <div class="breadcrumb-wrapper d-none d-sm-block">
                        <ol class="breadcrumb p-0 mb-0 pl-1">
                            ...
                            <li class="breadcrumb-item active txt-Success" style="color: green;">Produkt Ursprung Skapa
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <section class="users-edit">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form-validate" action="{{ route('admin.productorigin.store') }}" method="POST">
                            @csrf
                            <div class="row">
