            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="breadcrumbs-top">
                        <h5 class="content-header-title float-left pr-1 mb-0">Kupong</h5>
                        <div class="breadcrumb-wrapper d-none d-sm-block">
                            <ol class="breadcrumb p-0 mb-0 pl-1">
                                <li class="breadcrumb-item"><a href="/"><i class="bx bx-home-alt"></i></a>
                                </li>
                                <li class="breadcrumb-item active" style="color: green;">Kuponglista
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <div class="content-body">
                ...
                <section class="users-list-wrapper">
                    <div class="col-md-1  my-3 d-flex align-items-center">
                        <a href="{{ route('admin.coupons.create') }}" class="btn btn-outline-success"><span><i
                                        ...
                                        <tbody>
                                            @foreach ($list as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.coupons.edit', ['coupon' => $item->id]) }}"><i
                                                                class="bx bx-edit-alt" style="color: green;"></i></a>
                                                        <a href="{{ route('admin.coupons.destroy', ['coupon' => $item->id]) }}"
