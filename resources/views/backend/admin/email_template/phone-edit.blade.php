                                                            ...
                                                            <tbody>
                                                                            ...
                                                                            <tbody>
                                                                                <tr style="color: #4b4b4b;" bgcolor="#ffffff">
                                                                                    <th style="mso-line-height-rule: exactly; color: #4b4b4b;" bgcolor="#ffffff" valign="top">
                                                                                        <h1 data-key="1468266_heading" style="font-family: Georgia,serif,'Playfair Display'; font-size: 28px; line-height: 46px; font-weight: 700; color: #4b4b4b; text-transform: none; background-color: #ffffff; margin: 0; text-align: left;">
                                                                                            Ändra ditt nummer </h1>
                                                                                    </th>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                ...
                                                                <tr id="section-1468267" class="section introduction">
                                                                    <th style="mso-line-height-rule: exactly; padding: 13px 52px;" bgcolor="#ffffff">
                                                                        ...
                                                                        <p data-key="1468267_introduction_text" class="text" style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #4b4b4b; margin: 13px 0; text-align: left !important; margin-bottom: 30px;" align="left">Vill du ändra ditt nummer? Inga bekymmer klicka på följande länk för att ändra ditt nummer. </p>

                                                                        <a style="padding: 10px 25px; border-radius: 5px; color: white; background-color: #006d16; font-weight: 500; justify-content: center;" href="{{ route('profile') }}?request_time={{ encrypt(date('hd')) }}&phone_number={{ $data['phone'] }}">Ändra nummer</a>


                                                                        <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px !important; line-height: 26px; font-weight: 400; color: #4b4b4b; margin: 13px 0; text-align: left !important; margin-top: 30px;" align="left">Om du inte har begärt ändring nummer från Livshem.se kan du ignorera detta mejl. </p>

                                                                        <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px !important; line-height: 26px; font-weight: 400; color: #4b4b4b; margin: 13px 0; margin-bottom: 30px; text-align: left !important;" align="left">Behöver du komma i kontakt med oss, ring oss på 08-222 555 eller skicka ett mail till <a style="color: #006d16;" href="mailto:handla@livshem.se">handla@livshem.se</a></p>

                                                                        <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px !important; line-height: 26px; font-weight: 400; color: #4b4b4b; margin: 0px 0; text-align: left !important;" align="left">Tack och vänliga hälsningar,</p>

                                                                        <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px !important; line-height: 26px; font-weight: 400; color: #4b4b4b; margin: 0px 0; margin-bottom: 30px; text-align: left !important;" align="left">Livshem-team</p>


                                                                        <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px !important; line-height: 26px; font-weight: 400; color: #4b4b4b; margin-bottom: 1  0px; text-align: left !important;" align="left">Om du har problem med att klicka på länken “Bekräfta din e-postadress”, kopiera och klistra in webbadressen nedan i din webbläsare:</p>

                                                                        <p style="display:flex; justify-content:left !important;" align="left">
                                                                            <a style="color: #1e8800; font-weight: 500;" href="{{ route('profile') }}?request_time={{ encrypt(date('hd')) }}&phone_number={{ $data['phone'] }}">Ändra nummer</a>
                                                                        </p>
                                                                    </th>
                                                                </tr>
                                                            </tbody>
                                                                        ...
                                                                        <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="min-width: 100%;" role="presentation">
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <th width="50%" class="column_2_of_2 column_shop_block " style="mso-line-height-rule: exactly; padding-top: 26px; padding-bottom: 10px; border-top-width: 0px; border-top-color: #dadada; border-top-style: solid;" align="center" bgcolor="#ffffff" valign="top">
