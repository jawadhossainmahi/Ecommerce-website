        ...
        <ol class="inline-flex flex-wrap items-center space-x-1 md:space-x-3">
          ...
          <li aria-current="page">
            <div class="flex items-center">
              ...
              <a href="{{ env("BASE_URL") }}product/category?category={{ $sub_category[0]->getcategory->id }}" class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">{{ $sub_category[0]->getcategory->name }}</a>
            </div>
          </li>
          @endif
        </ol>
    ...
    <section class="fruit-and-vegitable">
        <div class="max-w-7xl mx-auto px-3">
            ...
            <div class="main-heading">
                <h1 class="text-left"> {{ $sub_category[0]->name }}</h1>
            </div>
...
<!-- -------------------filter----------------- -->
   ...
   @include('frontend.layouts.filter')
        ...
        <div class="max-w-7xl mx-auto px-3 py-4">
            ...
            <div class="row">
                ...
                <div class="catagories col-lg-3 d-none d-lg-block">
                    ...
                    @foreach ($subsub_category as $item)
                       @php
                ...
                <div id="sub-category" class="row col-12 col-lg-9 mx-auto" >
                ...
                @if($item ?? '')
                    @if($item->getsubcategory->id)
                
                      {{-- <div style="text-align:center"> --}}
                        <a class="btn btn-success my-4 LoadMore hidden" id="SubCategoryLoadMore" data-id="{{$item->getsubcategory->id}}"  >Ladda mer</a>
                        {{-- </div > --}}
                    @endif
                  @endif
                </div>
    ...
    <input type="hidden" id="page-id" value="{{ $item->getsubcategory->id }}"  >
    @endif
    @endif
    <div id="sub-category-modal"></div>
