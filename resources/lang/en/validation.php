...
return [
    ...
    */
    ...
    // 'required' => 'f채ltet 채r obligatoriskt :attribute De.',
    ...
    */
    ...
    'custom' => [
        ...
        'end_date' => [
        'required' => 'Fältet för slutdatum är obligatoriskt.',
    ],
     'start_date' => [
    ...
    'name'=>[
        'required' =>'Namn fältet är obligatoriskt.',
         ...
         'password'=>[
        'required' =>'Lösenordsfältet är obligatoriskt..',
        ],
        'email'=>[
        ...
        //  'amount'=>[
        // 'required' =>'Beloppsfältet är obligatoriskt.',
        // ],
         'status_id'=>[
        'required' =>'Fältet status_id är obligatoriskt.',
        ],
         'code'=>[
        'required' =>'Kodfältet är obligatoriskt.',
        ],
         'date'=>[
        ...
        'text1'=>[
        'required' =>'Frågefältet är obligatoriskt.',
        ],
        'text2'=>[
        'required' =>'Svarsfältet är obligatoriskt.',
        ],
        'user_id'=>[
        'required' =>'Fältet user_id är obligatoriskt.',
        ],
        'product_id'=>[
        'required' =>'Fältet product_id är obligatoriskt.',
        ],
        'status'=>[
        'required' =>'Statusfältet är obligatoriskt.',
        ],
        // 'text2'=>[
        // 'required' =>'Svarsfältet är obligatoriskt.',
        // ],
